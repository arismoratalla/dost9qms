...
<div class="message-view">
    ...
    if (isset(Yii::$app->getModule('message')->userProfileRoute)) {
        $from = Html::a($message->sender->username, array_merge(Yii::$app->getModule('message')->userProfileRoute, ['user_id' => $message->from]));
    } else {
        $from = $message->sender->username;
    }

    if (isset(Yii::$app->getModule('message')->userProfileRoute)) {
        $to = Html::a($message->recipient->username, array_merge(Yii::$app->getModule('message')->userProfileRoute, ['user_id' => $message->to]));
    } else {
