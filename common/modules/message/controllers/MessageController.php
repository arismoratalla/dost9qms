...
use common\modules\message\models\AllowedContacts;
use common\modules\message\models\IgnoreListEntry;
use common\modules\message\models\Message;
use common\modules\message\models\MessageSearch;
use Yii;
...
class MessageController extends Controller
{
    ...
    public function actionInbox()
    {
        ...
        $users = ArrayHelper::map(
            Message::find()->where(['to' => Yii::$app->user->id])->groupBy('to')->all(), 'from', 'sender.username');
        $Senders=ArrayHelper::map(
            Message::find()->where(['from' => Yii::$app->user->id])->groupBy('from')->all(), 'to', 'recipient.username');
