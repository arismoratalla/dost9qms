      ...
      <?php
        echo GridView::widget([
            ...
            'panel' => [
                    ...
                    'heading' => '<h2 class="panel-title"><i class="fas fa-folder-open"></i> Technical Records</h2>',
                    'type' => GridView::TYPE_PRIMARY,
                    'before'=>  Html::button('<i class="fas fa-plus"></i> Add', 
                                    [   'value' => Url::to([ 'document/createtechnicalrecord', 'qms_type_id' => $_GET['qms_type_id'] ]), 
                                        'title' => 'Add Document', 'class' => 'btn btn-info', 
                                        'style'=>'margin-right: 6px;', 'id'=>'buttonCreateRequest'
                                    ]),
                    'after'=>false,
                ],
